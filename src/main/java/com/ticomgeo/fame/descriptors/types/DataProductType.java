package com.ticomgeo.fame.descriptors.types;
...
import static com.ticomgeo.fame.descriptors.types.DataProductType.ProcessingActivityType.PROSECUTE;
import static com.ticomgeo.fame.descriptors.types.DataProductType.ProcessingActivityType.SEARCH;
...
public interface DataProductType {
	...
	static DataProductType of(String name,
	                          ProcessingActivityType... activityTypes) {
