 ...
 * <p>
 * See:
 * https://confluence.ticom-geo.com:8443/display/~jsneary/Fabric+Automated+Mission+Engine?focusedCommentId=56787391#FabricAutomatedMissionEngine
 * -InitializationParameterDescriptor
 */
public interface InitializationParameterDescriptor<T extends Type> {
	...
	static <T extends Type> InitializationParameterDescriptor of(String name,
	                                                             boolean required,
	                                                             Class<T> type) {
